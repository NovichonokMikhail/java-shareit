...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Optional<Booking> findTop1ByItemIdAndEndBeforeOrderByStartDesc(Long itemId, Instant end);

    Optional<Booking> findTop1ByItemIdAndStartAfterOrderByStartAsc(Long itemId, Instant end);
}