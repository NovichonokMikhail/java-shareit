...
import ru.practicum.gateway.exception.AccessDeniedException;
...
import ru.practicum.gateway.user.service.UserServiceImpl;
...
import static ru.practicum.gateway.item.service.ItemServiceImpl.ITEM_NOT_FOUND;
