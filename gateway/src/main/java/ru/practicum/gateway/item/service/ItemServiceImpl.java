...
import ru.practicum.gateway.booking.repository.BookingRepository;
...
import ru.practicum.gateway.item.mapper.CommentMapper;
import ru.practicum.gateway.item.model.Comment;
import ru.practicum.gateway.item.repository.ItemRepository;
import ru.practicum.gateway.item.repository.CommentRepository;
...
import static ru.practicum.gateway.request.service.ItemRequestServiceImpl.REQUEST_NOT_FOUND;
